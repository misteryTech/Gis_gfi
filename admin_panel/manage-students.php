        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mx-auto">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="manageDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="student-list.php">Students List</a></li>
                                    <li><a class="dropdown-item" href="encode-grades.php">Encode Grades</a></li>
                                </ul>
                              </li>
                <li class="nav-item dropdown"><a class="nav-link" href="manage-teacher.php">Manage Teacher</a>
...
<section class="py-5 mt-5">
    <div class="container py-5">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <form class="p-3 p-xl-4 form-floating" method="post" action="code.php" enctype="multipart/form-data" id="studentRegistrationForm">
    <div class="row mb-3">
        <div class="col-md-6">
...
<script>
    document.getElementById("studentRegistrationForm").addEventListener("submit", function (event) {
        ...
        // Simulate a successful submission (you can change this based on real validation)
        ...
        if (success) {
            swal({
                ...
                document.getElementById("studentRegistrationForm").submit(); // Submit form after alert
            });
        } else {
            swal({
